    ...
    if len(text) > 7:
        ...
        if FILE_AUTO_DELETE > 0:
            notification_msg = await message.reply(
                ...
                "🇬​🇦​🇲​🇪​ 🇮​🇸​🇪​🇳​🇬​ 🇵​🇪​🇳​🇬​🇭​🇦​🇸​🇮​🇱​ 🇨​🇺​🇦​🇳​ : https://heylink.me/telepenghasilcuan/",
                parse_mode=ParseMode.HTML,
                disable_web_page_preview=True  # set False kalau mau preview link
            )
            reload_url = (
        ...
        reply_markup = InlineKeyboardMarkup(
            [
                    [InlineKeyboardButton("• ᴍᴏʀᴇ ᴄʜᴀɴɴᴇʟs •", url="https://t.me/target4dofficiall/50")],
